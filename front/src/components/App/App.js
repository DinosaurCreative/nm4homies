...
function App() {
  ...
  }, [stickers, arrNumber, searchParams]);
  ...
  return (
    <div className="App">
      <div
        className={`App__warning-msg-container ${
          !warningMessage && "App__warning-msg-container_hidden"
        }`}
      >
