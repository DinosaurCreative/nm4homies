...
export const SideMenu = ({ setIsLogged, items, setItems, setArrNumber}) => {
  ...
  return (  
    ...
    <div className={`side-menu__background no-print ${menuHidden && 'side-menu__background_hidden'}`} id="background">
      <CSidebar className={`side-menu ${menuHidden && 'side-menu__hidden'}`}>
        ...
        <CButton color="danger" className={`side-menu__logout-btn ${menuHidden && 'side-menu__logout-btn_hidden'}`} onClick={signOutHandler}>Выйти</CButton>
